...
from ..hair.inpaint_ops import gen_conv, gen_deconv, dis_conv
from ..hair.inpaint_ops import random_bbox, bbox2mask, local_patch
from ..hair.inpaint_ops import spatial_discounting_mask
from ..hair.inpaint_ops import resize_mask_like, contextual_attention
